...
TRTASK=XVNLI
TETASK=XVNLIar
TEXT_PATH=data/XVNLI/annotations_machine-translate/ar/test_gmt.jsonl
PRETRAINED=checkpoints/iglue/zero_shot/xvnli/${MODEL}/${TRTASK}_${MODEL_CONFIG}/pytorch_model_best.bin
OUTPUT_DIR=results/iglue/zero_shot/xvnli/${MODEL}_gmt/${TRTASK}_${MODEL_CONFIG}/$TETASK/test
