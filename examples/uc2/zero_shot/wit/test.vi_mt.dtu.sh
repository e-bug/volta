...
TEXT_PATH=data/wit/annotations_machine-translate/test_${lang}_gmt.jsonl
...
OUTPUT_DIR=results/iglue/zero_shot/wit/${MODEL}_gmt/${TRTASK}_${MODEL_CONFIG}/$TETASK/test
