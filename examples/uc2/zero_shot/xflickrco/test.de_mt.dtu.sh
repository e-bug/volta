...
TEXT_PATH=data/xFlickrCO/annotations_machine-translate/${LANG}/test_gmt.jsonl
...
OUTPUT_DIR=results/iglue/zero_shot/xflickrco/${MODEL}_gmt/${TRTASK}_${MODEL_CONFIG}/$TETASK/test
