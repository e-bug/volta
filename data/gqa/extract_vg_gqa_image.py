...
def load_image_ids(img_root, group_id, total_group):
...
if __name__ == '__main__':
    ...
    args.outfile = "%s_obj%d-%d.tsv.%d" % ('vg_gqa', MIN_BOXES, MAX_BOXES, args.group_id)
    ...
    image_ids = load_image_ids(args.imgroot, args.group_id, args.total_group)
