...
def parse_args():
    ...
    parser.add_argument('--datadir', type=str, default='/data/bugliarello.e/data/gqa/vg_gqa_imgfeat')
...
if __name__ == '__main__':
    ...
    args = parse_args()
    args.outfile = os.path.join(args.datadir, "%s_obj%d-%d.tsv" % ('vg_gqa', MIN_BOXES, MAX_BOXES))
