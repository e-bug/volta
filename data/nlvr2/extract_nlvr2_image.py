...
def load_image_ids(img_root, split_name, group_id, total_group):
    ...
    lst = os.listdir(img_root)
    fnames = [{'filename': i} for i in lst]
...
if __name__ == '__main__':
    ...
    image_ids = load_image_ids(args.imgroot, args.split, args.group_id, args.total_group)
