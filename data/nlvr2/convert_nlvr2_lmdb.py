...
def parse_args():
    ...
    parser.add_argument('--indir', type=str, default='data/nlvr2/imgfeats')
    parser.add_argument('--outdir', type=str, default='data/nlvr2/imgfeats/volta')
    parser.add_argument('--split', type=str, default='nlvr2')
...
if __name__ == '__main__':
    ...
    args = parse_args()
    args.infiles = [os.path.join(args.indir, "nlvr2_obj36-36.tsv")]
