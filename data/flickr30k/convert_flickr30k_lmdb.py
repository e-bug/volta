...
def parse_args():
    ...
    parser.add_argument('--indir', type=str, default='data/flickr30k/imgfeats')
    parser.add_argument('--outdir', type=str, default='data/flickr30k/imgfeats/volta')
    parser.add_argument('--split', type=str, default='flickr30k', choices=['flickr30k', 'trainval', 'test'])
