...
def parse_args():
    ...
    parser.add_argument('--datadir', type=str, default='data/refcoco_unc/imgfeats')
...
if __name__ == '__main__':
    ...
    args = parse_args()
    args.outfile = os.path.join(args.datadir, "%s_obj%d-%d.tsv" % ('refcoco_unc_dets36', MIN_BOXES, MAX_BOXES))
