...
def parse_args():
    ...
    parser.add_argument('--datadir', type=str, default='data/refcoco+_unc/imgfeats')
...
if __name__ == '__main__':
    ...
    args = parse_args()
    args.outfile = os.path.join(args.datadir, "%s_obj%d-%d.tsv" % ('refcoco+_unc_dets36', MIN_BOXES, MAX_BOXES))
