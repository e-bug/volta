...
def parse_args():
    ...
    parser.add_argument('--indir', type=str, default='data/refcocog_umd/imgfeats')
    parser.add_argument('--outdir', type=str, default='data/refcocog_umd/imgfeats/volta')
...
if __name__ == '__main__':
    ...
    args = parse_args()
    args.infiles = [os.path.join(args.indir, "refcocog_umd_dets36_obj36-36.tsv")]
    args.outpath = os.path.join(args.outdir, "%s_feat.lmdb" % 'refcocog_umd_dets36')
